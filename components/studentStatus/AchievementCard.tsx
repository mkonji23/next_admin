...
const AchievementCard = ({
    ...
    const headerTemplate = (options: any) => {
        ...
        return (
            <div
                className={`flex align-items-center justify-content-between p-3 border-bottom-1 ${
                    isDark ? 'surface-card border-white-alpha-20' : 'bg-white border-gray-200'
                }`}
            >
                <div className="flex align-items-center gap-2">
                    <i className="pi pi-trophy text-yellow-500 text-xl"></i>
                    <span className={`font-bold text-lg ${isDark ? 'text-white' : 'text-900'}`}>
                        {currentMonth.format('M월')}의 명예의 전당
                    </span>
                </div>
            ...
            >
                <div className="grid p-3">
                    ...
                    <div className="col-12 md:col-6">
                        <div className={`p-3 border-round-lg h-full ${isDark ? 'surface-ground' : 'bg-gray-50'}`}>
                            <h3 className={`font-bold text-lg mt-0 mb-3 text-center ${isDark ? 'text-blue-300' : 'text-gray-700'}`}>
                                ✨ 이달의 칭찬 랭킹 ✨
                            </h3>
                            <ul className="list-none p-0 m-0">
                                {praiseTopRankers.map((ranker, index) => (
                                    <li
                                        ...
                                        className={`flex align-items-center justify-content-between p-3 mb-2 border-round-lg shadow-1 ${
                                    ...
                                    >
                                        ...
                                        <div className="flex align-items-center">
                                            ...
                                            <span className={`ml-1 ${isDark ? 'text-white-alpha-70' : 'text-gray-600'}`}>개</span>
                                        </div>
                                    </li>
                                ))}
                            </ul>
                    ...
                    <div className="col-12 md:col-6">
                        <div className={`p-3 border-round-lg h-full ${isDark ? 'surface-ground' : 'bg-gray-50'}`}>
                            <h3 className={`font-bold text-lg mt-0 mb-3 text-center ${isDark ? 'text-green-300' : 'text-gray-700'}`}>
                                🚀 나의 월별 요약 🚀
                            </h3>
                            <div className="flex flex-column gap-3">
                                <div
                                    className={`flex justify-content-between align-items-center p-3 border-round-lg shadow-1 ${
                                        isDark ? 'surface-card' : 'bg-white'
                                    }`}
                                >
                                    <div className="flex align-items-center">
                                        <i className="pi pi-heart-fill text-red-500 text-2xl mr-3" />
                                        <span className={`font-bold text-lg white-space-nowrap ${isDark ? 'text-white' : 'text-gray-800'}`}>
                                            총 칭찬
                                        </span>
                                    </div>
