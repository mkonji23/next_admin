                            ...
                            <div className="p-3">
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        <li>
                                            상단의 <strong>"수업클래스 선택"</strong> 드롭다운에서 클래스를 선택합니다.
                                        </li>
                                        <li>
                                            <strong>"월 선택"</strong> 캘린더에서 조회할 월을 선택합니다.
                                        </li>
                                        <li>클래스와 월을 모두 선택하면 해당 월의 출석부가 자동으로 로드됩니다.</li>
                                        <li>
                                            출석부가 없으면 자동으로 신규 생성되며,{' '}
                                            <Tag severity="success" value="출석부 신규생성완료!" /> 메시지가 표시됩니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        <li>
                                            각 학생의 날짜별 <strong>"출석"</strong> 컬럼에서 드롭다운을 클릭합니다.
                                        </li>
                                        <li>
                                            다음 중 하나를 선택합니다:
                                            <ul className="ml-4 mt-2">
                                                <li>
                                                    <Tag severity="secondary" value="없음" /> - 출석 상태 없음
                                                </li>
                                                <li>
                                                    <Tag severity="success" value="수업출석" /> - 정상 출석
                                                </li>
                                                <li>
                                                    <Tag severity="danger" value="수업결석" /> - 결석
                                                </li>
                                                <li>
                                                    <Tag severity="info" value="보강출석" /> - 보강 수업 출석
                                                </li>
                                                <li>
                                                    <Tag severity="warning" value="보강결석" /> - 보강 수업 결석
                                                </li>
                                                <li>
                                                    <Tag severity="primary" value="클리닉출석" /> - 클리닉 출석
                                                </li>
                                                <li>
                                                    <Tag severity="danger" value="클리닉결석" /> - 클리닉 결석
                                                </li>
                                            </ul>
                                        </li>
                                    </ol>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        <li>
                                            각 학생의 날짜별 <strong>"숙제"</strong> 컬럼에서 드롭다운을 클릭합니다.
                                        </li>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            저장이 완료되면 <Tag severity="success" value="출석부가 저장되었습니다." />{' '}
                                            메시지가 표시됩니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        <li>
                                            <Button label="오늘날짜로" icon="pi pi-refresh" className="p-button-sm" />{' '}
                                            버튼을 클릭하면 현재 날짜 컬럼으로 자동 스크롤됩니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ul className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            출석부가 없으면 자동으로 생성되며, 해당 클래스의 모든 학생이 포함됩니다.
                                        </li>
                        ...
                        <AccordionTab header="사용자 목록">
                            <div className="p-3">
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            ...
                                            <ul className="ml-4 mt-2">
                                                <li>
                                                    <strong>이메일</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>비밀번호</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>사용자 ID</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>사용자 이름</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>권한</strong> (필수) - 관리자, 학생, 선생님, 학부모님 중
                                                    선택
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <Button label="등록" icon="pi pi-check" className="p-button-sm" /> 버튼을
                                            클릭하여 저장합니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        <li>
                                            ...
                                            <Button
                                                icon="pi pi-pencil"
                                                className="p-button-warning p-button-sm p-button-rounded p-button-outlined"
                                            />{' '}
                                            버튼을 클릭합니다.
                                        </li>
                                        <li>팝업에서 정보를 수정합니다.</li>
                                        <li>
                                            <Button label="저장" icon="pi pi-check" className="p-button-sm" /> 버튼을
                                            클릭하여 저장합니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        <li>
                                            ...
                                            <Button
                                                icon="pi pi-key"
                                                className="p-button-secondary p-button-sm p-button-rounded p-button-outlined"
                                            />{' '}
                                            버튼을 클릭합니다.
                                        </li>
                                        <li>확인 메시지에서 확인을 클릭하면 비밀번호가 초기화됩니다.</li>
                                        <li>
                                            초기 비밀번호는 <strong>"chocho1234"</strong>입니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ul className="ml-4 line-height-3">
                                        <li>
                                            권한 컬럼에는 선택한 권한의 라벨이 표시됩니다 (관리자, 학생, 선생님,
                                            학부모님).
                                        </li>
                            ...
                            <div className="p-3">
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>필터 기능을 사용하여 특정 조건으로 검색할 수 있습니다.</li>
                                        <li>
                                            각 행의 왼쪽 확장 아이콘(▶)을 클릭하면 해당 학생이 수강 중인 수업 목록을
                                            확인할 수 있습니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            ...
                                            <ul className="ml-4 mt-2">
                                                <li>
                                                    <strong>이름</strong> (필수) - 쉼표(,)로 구분하여 여러 명을 한 번에
                                                    등록할 수 있습니다 (예: 홍길동, 김철수, 이영희)
                                                </li>
                                                <li>
                                                    <strong>학년</strong> (필수) - 드롭다운에서 선택 (1, 2, 3)
                                                </li>
                                                <li>
                                                    <strong>학교</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>등록일자</strong> (선택) - 캘린더에서 선택 (미입력 시 현재
                                                    날짜)
                                                </li>
                                                <li>
                                                    <strong>설명</strong> (선택) - 여러 줄 입력 가능
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>팝업에서 정보를 수정합니다.</li>
                                        <li>
                                            수정 모드에서는 <strong>"퇴원 여부"</strong> 체크박스가 표시되어 퇴원 상태를
                                            변경할 수 있습니다.
                                        </li>
                                        <li>
                                            <Button label="저장" icon="pi pi-check" className="p-button-sm" /> 버튼을
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            ...
                                            <ul className="ml-4 mt-2">
                                                <li>
                                                    각 학생 행의 <strong>"작업"</strong> 컬럼에서 상태에 따라 버튼이
                                                    표시됩니다:
                                                    <ul className="ml-4 mt-2">
                                                        <li>
                                                            재학 중인 학생:{' '}
                                                        ...
                                                        <li>
                                                            ...
                                                            <Button
                                                                icon="pi pi-sign-in"
                                                                className="p-button-success p-button-sm p-button-rounded p-button-outlined"
                                                            />{' '}
                                                            (입원) 버튼
                                                        </li>
                                                    </ul>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ul className="ml-4 line-height-3">
                                        <li>
                                            상태 컬럼에서 <Tag severity="success" value="재학" /> 또는{' '}
                                            <Tag severity="danger" value="퇴원" /> 상태를 확인할 수 있습니다.
                                        </li>
                            ...
                            <div className="p-3">
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>필터 기능을 사용하여 특정 조건으로 검색할 수 있습니다.</li>
                                        <li>
                                            각 행의 왼쪽 확장 아이콘(▶)을 클릭하면 해당 클래스에 등록된 학생 목록을
                                            확인할 수 있습니다.
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            ...
                                            <ul className="ml-4 mt-2">
                                                <li>
                                                    <strong>클래스명</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>선생님</strong> (필수)
                                                </li>
                                                <li>
                                                    <strong>학생</strong> (선택) -{' '}
                                                    <Button
                                                ...
                                                <li>
                                                    <strong>개강일시</strong> (선택) - 캘린더에서 선택
                                                </li>
                                                <li>
                                                    <strong>종강일시</strong> (선택) - 캘린더에서 선택
                                                </li>
                                                <li>
                                                    <strong>종강 여부</strong> (선택) - 체크박스로 선택
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                ...
                                <div className="mb-4">
                                    ...
                                    <ol className="ml-4 line-height-3">
                                        ...
                                        <li>
                                            ...
                                            <ul className="ml-4 mt-2">
                                                <li>
                                                    각 클래스 행의 <strong>"작업"</strong> 컬럼에서 상태에 따라 버튼이
                                                    표시됩니다:
                                                    <ul className="ml-4 mt-2">
                                                        <li>
                                                            진행 중인 클래스:{' '}
                                ...
                                <div className="mb-4">
                                    ...
                                    <ul className="ml-4 line-height-3">
                                        <li>
                                            상태 컬럼에서 <Tag severity="success" value="진행중" /> 또는{' '}
                                            <Tag severity="danger" value="종강" /> 상태를 확인할 수 있습니다.
                                        </li>
